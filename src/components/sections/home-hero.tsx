...
export function HomeHero() {
  ...
  return (
    <section className="relative w-full bg-background" aria-label="Hero Section">
      ...
      <BackgroundBeamsWithCollision className="min-h-[100dvh] h-auto w-full bg-background flex-col justify-start">
        ...
        <div className="container mx-auto relative z-10 text-center px-4 sm:px-6 pt-32 sm:pt-40 pb-12 sm:pb-20">
          ...
          <motion.div
            ...
            className="hidden md:grid mt-16 sm:mt-20 md:mt-24 pt-8 sm:pt-10 border-t border-border/40 grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto px-4"
          >
